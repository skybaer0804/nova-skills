---
name: agent-a2ui
description: Use when an AI agent needs to return structured, interactive UI for a frontend — when it should produce cards, forms, buttons, or dashboards instead of plain text.
created: 2026-05-05
updated: 2026-05-05
---
